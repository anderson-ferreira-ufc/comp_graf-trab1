...
import { sat_sol_dist, saturnoTranslacao, saturnoAnelTranslacao } from './saturno.mjs';
...
window.addEventListener('keydown', (event) => {
    switch (event.key) {
        case '+':
            ...
            break;
        case '=':
            if (animationSpeed > 0.1) { // evita velocidade menor que 0
        ...
        case ' ':
            ...
            aux = 1;
            //document.getElementById("velocidade").innerHTML = aux;
            document.getElementById("velocidade").innerHTML = animationSpeed.toFixed(1);
            break;
        case 'p':
            if (animationSpeed == 0) { // se ja estiver pausado despausa e volta ao inicio
