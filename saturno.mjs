...
export const sat_sol_dist =
  (esc_dist * (1432000000 + 696340 + 60268)) / (149600000 + 696340 + 6378); // 571.95 = Distância entre os centros de Saturno e Sol.

export const raio_satAnel = 137000;
export const satAnel_sol_dist =
  (esc_dist * (1432000000 + 696340 + 60268)) / (149600000 + 696340 + 6378); // 571.95 = Distância entre os centros de Saturno e Sol.
...
export function saturnoAnelTranslacao() {
  const satAnel_loader = new THREE.TextureLoader().load(
    "textures/sat_anel_tex.jpg"
  );
  const geo_satAnel = new THREE.TorusGeometry(
    raio_satAnel / raio_terra,
    7,
    2,
    100
  ); // Proporção anel de Saturno / Terra = 21.48
