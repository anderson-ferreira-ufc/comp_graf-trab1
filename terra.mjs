...
export const terra_sol_dist = (esc_dist*(149600000 + 696340 + 6378)/(149600000 + 696340 + 6378)); // Distância entre os centros da Terra e Sol.
...
export const lua_sol_dist = esc_dist*(149600000 + 696340 + 6378)/(149600000 + 696340 + 6378); // Fixando o centro da Lua com o da Terra (concêntrico).
