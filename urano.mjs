...
export const ura_sol_dist =
  (esc_dist * (2867000000 + 696340 + 25559)) / (149600000 + 696340 + 6378); // 1144.80 = Distância entre os centros de Urano e Sol.
